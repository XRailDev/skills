 ...
 */
final class Version20191011101740 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE skill (id INT AUTO_INCREMENT NOT NULL, person_id INT NOT NULL, name VARCHAR(255) NOT NULL, level VARCHAR(255) NOT NULL, INDEX IDX_5E3DE477217BBB47 (person_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
